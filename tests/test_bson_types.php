...
echo "\n-- Interface hierarchy --\n";
assert_true('Serializable extends Type',
    is_subclass_of(Serializable::class, Type::class, true));
assert_true('Persistable extends Serializable',
    is_subclass_of(Persistable::class, Serializable::class, true));
assert_true('Persistable extends Unserializable',
...
echo "\n-- ObjectId validation --\n";
assert_throws('ObjectId rejects short string', \InvalidArgumentException::class,
    fn() => new ObjectId('abc'));
assert_throws('ObjectId rejects non-hex', \InvalidArgumentException::class,
    fn() => new ObjectId('zzzzzzzzzzzzzzzzzzzzzzzz'));
assert_throws('ObjectId rejects 23-char string', \InvalidArgumentException::class,
    fn() => new ObjectId('507f1f77bcf86cd79943901'));
assert_throws('ObjectId rejects 25-char string', \InvalidArgumentException::class,
    fn() => new ObjectId('507f1f77bcf86cd7994390111'));
...
echo "\n-- Construction --\n";
$utc = new UTCDateTime();
assert_true('UTCDateTime default is current time (ms)',
...
assert_throws('Document fromJSON invalid', \InvalidArgumentException::class,
    fn() => Document::fromJSON('not json'));

echo "\n-- Document missing key --\n";
assert_throws('Document get missing key', \OutOfRangeException::class,
    fn() => $doc->get('nonexistent'));

echo "\n-- Document immutability --\n";
assert_throws('Document offsetSet throws', \LogicException::class,
    fn() => $doc['name'] = 'Bob');
assert_throws('Document offsetUnset throws', \LogicException::class,
    function() use ($doc) { unset($doc['name']); });
...
assert_throws('PackedArray fromJSON invalid', \InvalidArgumentException::class,
    fn() => PackedArray::fromJSON('not json'));
assert_throws('PackedArray fromJSON object', \InvalidArgumentException::class,
    fn() => PackedArray::fromJSON('{"a":1}'));

echo "\n-- PackedArray missing index --\n";
assert_throws('PackedArray get missing index', \OutOfRangeException::class,
    fn() => $arr->get(99));

echo "\n-- PackedArray immutability --\n";
assert_throws('PackedArray offsetSet throws', \LogicException::class,
    fn() => $arr[0] = 999);
assert_throws('PackedArray offsetUnset throws', \LogicException::class,
    function() use ($arr) { unset($arr[0]); });
