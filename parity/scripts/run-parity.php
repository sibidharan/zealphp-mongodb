...
$ops = ['reset', 'crud', 'query', 'aggregate', 'types', 'indexes', 'bulk', 'txn_commit', 'txn_abort', 'change_stream', 'gridfs', 'errors', 'options', 'int_types', 'write_results', 'insert_ids', 'bulk_ids', 'find_opts', 'index_spec', 'list_filter', 'index_flags', 'empty_shapes', 'txn_state', 'create_coll', 'drop_index_info', 'pipeline_update', 'type_map', 'db_info', 'collation', 'ordered', 'bypass_validation', 'wc_ack', 'cs_fields', 'cs_invalidate', 'aggregate_opts', 'bson_containers', 'client_manager', 'concern_getters', 'server_selection_timeout', 'create_indexes_opts', 'map_reduce_parity', 'index_conflict', 'gridfs_meta_omit', 'txn_invalid_read_concern', 'txn_unsat_write_concern', 'read_pref_routing', 'cs_fulldoc_deleted', 'bson_sentinel_conflation'];
