...
$ops = ['reset', 'crud', 'query', 'aggregate', 'types', 'indexes', 'bulk', 'txn_commit', 'txn_abort', 'change_stream', 'gridfs', 'errors', 'options', 'int_types', 'write_results', 'insert_ids', 'bulk_ids', 'find_opts', 'index_spec'];
