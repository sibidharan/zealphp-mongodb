...
class ArrayCursor implements \Iterator
{
    ...
    public function current(): Document|array|null { return $this->docs[$this->pos] ?? null; }
    public function key(): int { return $this->pos; }
    public function next(): void { $this->pos++; }
    public function rewind(): void { $this->pos = 0; }
    public function valid(): bool { return isset($this->docs[$this->pos]); }

    public function toArray(): array { return $this->docs; }

    public function sort(array $sort): self
    {
        usort($this->docs, function ($a, $b) use ($sort) {
